...
import com.dianaui.universal.core.client.ui.gwt.ButtonBase;
 ...
 * @see Radio
 */
public class CheckBox extends ButtonBase implements HasHTML, HasName, HasValue<Boolean>, HasWordWrap,
