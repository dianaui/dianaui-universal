...
public class RichTextToolbar extends Composite {
    ...
    @UiField
    Button redoButton;
    private com.dianaui.universal.core.ui.base.RichTextArea richText;
     ...
     */
    public RichTextToolbar(final com.dianaui.universal.core.ui.base.RichTextArea richText) {
      ...
      */
        ...
        public void onClick(ClickEvent event) {
            ...
            if (sender == boldButton) {
                ...
                richText.getFormatter().setJustification(com.dianaui.universal.core.ui.base.RichTextArea.Justification.LEFT);
            } else if (sender == justifyCenterButton) {
                richText.getFormatter().setJustification(com.dianaui.universal.core.ui.base.RichTextArea.Justification.CENTER);
            } else if (sender == justifyRightButton) {
                richText.getFormatter().setJustification(com.dianaui.universal.core.ui.base.RichTextArea.Justification.RIGHT);
