...
import com.dianaui.universal.core.ui.AnchorListItem;
import com.dianaui.universal.core.ui.DropDownMenu;
...
public abstract class AbstractSuggestBox<T> extends Composite implements LeafValueEditor<T>, HasValue<T>,
    ...
    /**
     * Constructor for {@link SuggestBox}. Creates a {@link com.dianaui.universal.core.ui.TextBox} to use with
     * this {@link SuggestBox}.
     *
     * @param oracle the oracle for this <code>SuggestBox</code>
     */
    public AbstractSuggestBox(SuggestOracle oracle) {
        this(oracle, new com.dianaui.universal.core.ui.TextBox());
    }
